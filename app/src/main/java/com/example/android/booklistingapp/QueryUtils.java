...
public class QueryUtils {
    //Private constructor - no one should ever create an object.
    private QueryUtils() {
    }
        ...
        try {
            ...
            for (int i = 0; i < bookArray.length(); i++) {
                ...
                if (volumeInfo.has("authors")) {
                    ...
                    for (int n = 1; n < authorsArray.length(); n++) {
                            authors.append(", ");
                            authors.append(authorsArray.getString(n));
                    }
                } else {
                    authors.append("Unkown Author");
                }
            ...
            Log.e("QueryUtils", "Problem parsing the book results", e);
        }
